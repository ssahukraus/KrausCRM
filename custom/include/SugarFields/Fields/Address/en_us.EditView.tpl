...
{{assign var="country_code" value='country_code_c'}}
...
<select name="{{$country_code}}" width="{{$displayParams.size|default:30}}" id="{{$country}}" title="{{$vardef.help}}" tabindex="{{$tabindex}}" {{if isset($displayParams.script)}}{{$displayParams.script}}{{/if}}>
{if isset($fields.{{$country_code}}.value) && $fields.{{$country_code}}.value != ''}
     {html_options options=$fields.{{$country_code}}.options selected=$fields.{{$country_code}}.value}
{else}
     {html_options options=$fields.{{$country_code}}.options selected=$fields.{{$country_code}}.default_value}
{/if}
</select>     
</td>
</tr>
