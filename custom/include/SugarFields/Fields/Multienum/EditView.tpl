...
{if !isset($config.enable_autocomplete) || $config.enable_autocomplete==false}
	...
	{html_checkboxes name={{sugarvar key='name' string=true}}  values={{sugarvar key='options' string=true}}  output={{sugarvar key='options' string=true}} selected=$values separator='<br/>' style='margin-right:5px;'}
