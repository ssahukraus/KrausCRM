 ...
 * PLACE ANY CUSTOMIZATIONS IN SM_BusinessUnits
 */

require_once('include/SugarObjects/templates/company/Company.php');

class SM_BusinessUnits_sugar extends Company {
	var $new_schema = true;
	var $module_dir = 'SM_BusinessUnits';
	var $object_name = 'SM_BusinessUnits';
	var $table_name = 'sm_businessunits';
	var $importable = true;
	...
	function SM_BusinessUnits_sugar(){	
		parent::Company();
	}
