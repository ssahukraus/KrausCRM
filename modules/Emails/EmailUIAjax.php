...
eoq;
   ...
   break;
    ...
    case "getAddressSearchResults":
		...
		/*
		 * Modified by suraj
		 * to remove the data_error on the partner pannel
		 */
		if ($relatedBeanInfo['related_bean_type'] === 'Kr_Dealers' || strtolower($relatedBeanInfo['related_bean_type']) === 'kr_dealers') {
			$qArray = array('query' => '', 'countQuery' => 'SELECT count(people.id) c from () people');
		} else {
