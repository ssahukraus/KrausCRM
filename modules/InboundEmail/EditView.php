...
/*Alex Assign Case*/
$user_templates_arr = get_bean_select_array(true, 'User','user_name', '','user_name',true);
unset($user_templates_arr[1]); //fixed admin selected
$user_templates_mailboxes_skip=get_bean_select_array(true, 'InboundEmail','email_user', '','email_user',true);
 
$user_templates_mailboxes_skip=array_combine($user_templates_mailboxes_skip,$user_templates_mailboxes_skip);
...
if(!empty($focus->stored_options)) {
	...
	/*Alex Assign Case*/	 
	$selected_uids=(isset($storedOptions['create_case_user_id'])) ? $storedOptions['create_case_user_id'] : "";
	$selected_uids_arr=explode(',',$selected_uids);	 
	$create_assign_email_user =$selected_uids_arr;  
	$selected_emails_skip=(isset($storedOptions['create_case_skip_emails'])) ? $storedOptions['create_case_skip_emails'] : "";
	$selected_emails_skip_arr=explode(',',$selected_emails_skip);	 
	$create_assign_email_skip=$selected_emails_skip_arr;
	/*Alex Assign Case*/
...
/*Alex Assign Case*/
$xtpl->assign('CREATE_CASE_USER_EMAIL_TEMPLATE_OPTIONS', get_select_options_with_id($user_templates_arr, $create_assign_email_user));
$xtpl->assign('CREATE_CASE_USER_EMAIL_SKIP', get_select_options_with_id($user_templates_mailboxes_skip, $create_assign_email_skip));
/*Alex Assign Case*/
