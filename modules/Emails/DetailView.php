...
if (!$focus->description) {
	$description_html=strip_tags(nl2br(str_replace("<p","<br/><p",$focus->description_html)),"<br/>");
}else {
	$description_html=nl2br(from_html($focus->description));
}

$xtpl->assign('DESCRIPTION_HTML', $description_html); // sashas
//Sashas tags

//$xtpl->assign('DESCRIPTION_HTML',  nl2br(from_html($focus->description))); //Sashas switched to plainview
