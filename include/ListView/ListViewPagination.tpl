			...
			<table border='0' cellpadding='0' cellspacing='0' width='100%' class='paginationTable'>
				<tr>
					<td nowrap="nowrap" width='2%' class='paginationActionButtons'>
						...
						&nbsp;{$selectedObjectsSpan}
						{*@suraj
                        added this code to show a download button on the listview for the partner module 
                        *}
                        {php}
                           global $currentModule;
                            if($currentModule == "kr_Dealers"){
                                echo '<input id="{$moduleName}" onclick="void(window.open(\'http://reports.kraususa.net/ReportServer/Pages/ReportViewer.aspx?%2fBI+Reports%2fCRM+Contacts+Partners&amp;rs:Command=Render&amp;rs:Format=EXCEL&amp;rc:LinkTarget=_blank\'))" type="button" value="Download Contact List" style="margin: 0;"/>';
                            }
                         {/php} 
                          {*@suraj
                          code end here
